...
open class CardSliderViewController: UIViewController, UIScrollViewDelegate {
	...
	private func showCardDescription(for indexPath: IndexPath) {
        ...
        //Assign book contents to textfield and resize
        textView?.text = dataSource.item(for: dataSource.numberOfItems() - indexPath.item - 1).description
        textViewHeightConstraint.constant = CGFloat(8100)
